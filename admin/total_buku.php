...
// Hitung total harga dan total stok
$totalHarga = 0;
$totalStok = 0;
$totalKategori = mysqli_num_rows($kategoriList);
...
<div class="container">
    ...
    <?php if (!$adaKategori): ?>
        <div class="alert-warning">
            ...
            <div>
                <strong>Belum ada kategori!</strong> Anda harus membuat kategori terlebih dahulu sebelum dapat menambahkan buku.
                <a href="kelola_kategori.php"><i class="fas fa-arrow-right"></i> Buat Kategori Sekarang</a>
            </div>
        </div>
    <?php endif; ?>
   <a href="#" style="text-decoration: none; color: inherit;">
      <div class="stats-grid">
       ...
       <a href="kelola_kategori.php" style="text-decoration: none; color: inherit;">
    <div class="stat-card">
   ...
   <div class="stat-card">
    ...
    <div class="filter-bar">
        <div class="filter-group">
            ...
            <form method="GET" action="" style="width: 100%;" id="searchForm">
                <?php if($kategori_id > 0): ?>
                    <input type="hidden" name="kategori_id" value="<?= $kategori_id; ?>">
                <?php endif; ?>
                <input type="text" name="q" placeholder="Judul atau penulis..." value="<?= htmlspecialchars($keyword); ?>" onkeyup="if(event.keyCode==13) this.form.submit()">
            </form>
        </div>
        <div class="filter-group">
            <label><i class="fas fa-filter"></i> Filter Kategori</label>
            <form method="GET" action="" style="width: 100%;" id="kategoriForm">
                <?php if($keyword): ?>
                    <input type="hidden" name="q" value="<?= htmlspecialchars($keyword); ?>">
                <?php endif; ?>
                <select name="kategori_id" onchange="this.form.submit()" <?= !$adaKategori ? 'disabled' : ''; ?>>
        ...
        <div class="filter-group">
            ...
            <?php else: ?>
                <span class="btn-add-disabled" title="Buat kategori terlebih dahulu">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="category-badge"><?= htmlspecialchars($nama_kategori); ?></span></td>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <?php else: ?>
                <a href="kelola_kategori.php" class="btn-add" style="margin-top: 1rem; background: var(--accent-gold);">
                    <i class="fas fa-tags"></i> Buat Kategori Terlebih Dahulu
                </a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
        ...
        <div class="footer-grid">
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="kelola_kategori.php">Kategori</a></li>
